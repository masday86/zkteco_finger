...
import dev.myhd.zkteco_finger.util.FingerStatus;
...
/** ZktecoFingerPlugin */
public class ZktecoFingerPlugin implements FlutterPlugin, MethodCallHandler, FingerListener {
  ...
  private ZktecoFingerPlugin(Registrar registrar) {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
      channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "zkteco_finger");
        initFingerStatusChangeListener(registrar);
        initFingerImageListener(registrar);

        final ZktecoFingerPlugin instance = new ZktecoFingerPlugin(registrar);
