...
public class ZkFingerPlugin implements MethodCallHandler, FingerListener {
    ...
    private static final String CHANNEL_FINGER_STATUS_CHANGE = "dev.myhd.zkteco_finger/status_change";
    private static final String CHANNEL_FINGER_IMAGE = "dev.myhd.zkteco_finger/finger_image";
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "zkteco_finger");
